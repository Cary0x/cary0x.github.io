...
Enter 46 and 258 into the Calculator and it says you need about 3660 swaps to get to 615. (Again, not taking into account initial, badge, or purchased boost, so it should be sooner).
