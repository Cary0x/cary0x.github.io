...
- The mining status looks for all active Mining sessions that reported a &gt;10M unclaimed amount in the past 10 seconds.
- The second number is the total number of unique miners sending valid signals in the past 10 seconds. If this ever goes to 0, then mining is either completely down or untested for up/down.
