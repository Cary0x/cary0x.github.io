...
This calculator is used to determine how to reach 515 boost via Swaps. (Previously 415)
...
**Swaps Needed for 515** - If your Current Boost is below 515, this is the number of Swaps you need to get there.

**Sessions until 515** - If your Current Boost is above 515, this is the number of Sessions you have until your Boost is below 515.

**Sessions until 0** - If your Current Boost is below 515, this is the number of Sessions you have until your Boost is below 0.
...
Enter 46 and 258 into the Calculator and it says you need about 3660 swaps to get to 515. (Again, not taking into account initial, badge, or purchased boost, so it should be sooner).
