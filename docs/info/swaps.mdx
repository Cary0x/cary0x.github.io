...
This calculator is used to determine how to reach 415 boost via Swaps.
...
**Swaps Needed** - If your Current Boost is below 415, this is the number of Swaps you need to get there.

**Sessions to 415** - If your Current Boost is above 415, this is the number of Sessions you have until your Boost is below 415.

**Sessions to 0** - If your Current Boost is below 415, this is the number of Sessions you have until your Boost is below 0.
...
Enter 46 and 258 into the Calculator and it says you need about 3060 swaps to get to 415. (Again, not taking into account initial, badge, or purchased boost, so it should be sooner).
