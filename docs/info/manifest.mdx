...
**Swaps** - The number of swaps you have done that Pond0x recognizes. (This system has additional filters, such as minimum amount or swap pairs, so it will not be perfectly aligned to your on-chain transaction history.)
...
**Pro Expiry** - The date and time in which your Pro will expire.

**Pro Ago (Deprecated)** - Counts how many days since your last Pro purchase. If it is greater than 30 (for a monthly purchase), you are up for renewal.
